        ...
        <Form ref="formInline" :model="examSearch"
            ...
            <FormItem label="考试类型:" prop="examType">
                <Select v-model="examSearch.examType"  filterable clearable>
                    <Option v-for="item in examSearch.examTypeMap" :value="item.key" :key="item.key">{{ item.name }}</Option>
                </Select>
            </FormItem>

            <FormItem label="考试状态:" prop="examStatus">
                <Select v-model="examSearch.examType"  filterable clearable>
                    <Option v-for="item in examSearch.examStatusMap" :value="item.key" :key="item.key">{{ item.name }}</Option>
                </Select>
            </FormItem>

            <FormItem label="考试时间:" prop="examTimeRange">
                <DatePicker type="datetimerange" v-model="examSearch.examTimeRange" format="yyyy-MM-dd"></DatePicker>
            </FormItem>
        </Form>
